...
import static com.zhoumai.qingtao.goodslayout.SlideDebug.DEBUG;
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
                    if (DEBUG) {
                        Log.d("goods", "intercept, child can scroll vertically, do not intercept");
                    }
                } else {
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        if (DEBUG) {
                            Log.d("goods", "intercept, intercept events");
                        }
                    }
                }
                break;
